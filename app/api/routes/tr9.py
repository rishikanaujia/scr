...
@router.get(
    ...
    **IMPORTANT**: All type, country, industry, and status parameters require NUMERIC ID values, not text names.
    - Use type=14 (not "Buybacks")
    - Use country=213 (not "USA")
    - Use industry=32 (not "Technology")
...
async def query_transactions(
        ...
        type: str = Query(
            None,
            description="Transaction type ID (numeric). Use specific ID values: 1=M&A, 2=Acquisitions, 7=Spin-offs, 10=Fund Raises, 12=Bankruptcies, 14=Buybacks. Example: '14' for Buybacks, NOT 'Buybacks'.",
            example="14",
        ...
        country: str = Query(
            None,
            description="Country ID (numeric). Use specific numeric ID values (e.g., 213=USA, 37=UK). Always use country ID numbers, NOT country names.",
            example="213",
            openapi_extra={"nullable": True}
        ),
        industry: str = Query(
            None,
            description="Industry ID (numeric). Use specific numeric ID values (e.g., 32=Technology, 56=Finance). Always use industry ID numbers, NOT industry names.",
            example="32",
            openapi_extra={"nullable": True}
        ),
        # Company identifiers
        ...
        statusId: str = Query(
            None,
            description="Transaction status ID (numeric). Use specific ID values: 2=Completed. Always use status ID numbers, NOT status names.",
            example="2",
            openapi_extra={"nullable": True}
        ),
        # Currency related
        currencyId: str = Query(
            None,
            description="Currency ID (numeric). Use specific ID values: 50=USD, 49=EUR, 22=GBP. Always use currency ID numbers, NOT currency names or codes.",
            example="50",
            openapi_extra={"nullable": True}
        ),
        ...
        relationType: str = Query(
            None,
            description="Relation type ID (numeric). Use specific ID values: 1=Buyer-Target, 2=Seller. Always use relation type ID numbers, NOT names.",
            example="1",
            openapi_extra={"nullable": True}
        ),
        ...
        advisorTypeId: str = Query(
            None,
            description="Advisor type ID (numeric). Use specific ID values: 2=Legal. Always use advisor type ID numbers, NOT names.",
            example="2",
            openapi_extra={"nullable": True}
        ),
